...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "nick0668"         # 用户名
UUID = "f23f2989-9e14-429d-a830-49895d6f8cdd"                     # UUID，留空则自动生成
...
def generate_links(domain, port_vm_ws, uuid_str):
    ...
    cf_ips_tls = {}
    cf_ips_tls.update({"20.2.25.102": "443","23.102.235.61": "443","207.46.138.8": "443","20.2.25.100": "443","156.254.114.171": "443","20.2.1.6": "443","62.60.231.8": "443","62.60.231.190": "443","62.60.251.250": "443","35.220.197.93": "443","62.60.250.141": "443","62.60.229.110": "443","62.60.237.175": "443","62.60.230.145": "443"})
    cf_ips_http = {
